...
from typing import Generic, Callable, Optional, Literal, Any
...
class VariationalParameterPosterior(eqx.Module, Generic[ParametersType]):
    dim: int
    base_approximation: BaseApproximation
    constraint: Constraint
    target_parameters: ParametersType
