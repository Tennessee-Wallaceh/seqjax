...
class MultivariateNormalTriTest(equivalence.EquivalenceTest):
    ...
    def test_properties(
        self, batch_shape, loc_shape, scale_tri_shape, is_lower
    ) -> None: ...
    def test_sample_shape(self, sample_shape, loc_shape, scale_tri_shape) -> None: ...
    def test_sample_dtype(self, dtype) -> None: ...
    def test_log_prob(
        self, value_shape, loc_shape, scale_tri_shape, is_lower
    ) -> None: ...
    def test_method(self, loc_shape, scale_tri_shape) -> None: ...
